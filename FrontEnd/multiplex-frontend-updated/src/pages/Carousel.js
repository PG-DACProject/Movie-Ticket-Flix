...
export default function Carouselslide() {
  ...
  const handleSearch=e=>{
      e.preventDefault()
      axios.get('http://localhost:8080/api/shows/search?hallId='+hallId+"&date="+date+"&movieName="+movieName+"&slot="+slot,{
        headers: {
  ...
  return (
    ...
    <div className='mt-5'>
      <div className="d-block w-100"
         style={{height:"500px",backgroundImage:"url('header.jpg')",backgroundSize:"100% 150%"}}>
           <form className="d-block mx-auto" style={{width:"80%",position:"absolute",top:"44%",left:"50%",transform:"translate(-50%,-50%)"}}>
             <div className='row'>
               ...
               <div className='col-sm-2'>
                ...
                <button onClick={handleSearch} className="btn btn-primary bg-gradient text-white" type="submit"><i className="fa fa-search"></i></button>
                </div>
                </div>
            </form>
         </div>
